...
print("=" * 100)
print(
    "R2.1-S TRUE SIZE-AWARE EVALUATION"
)
print("=" * 100)
...
json_path = (
    OUT
    / "teacher_s_r21_preserve_v1_size_aware.json"
)

csv_path = (
    OUT
    / "teacher_s_r21_preserve_v1_size_aware.csv"
)

...
print("=" * 100)
print(
    "R2-S TRUE SIZE-AWARE EVALUATION"
)
print("=" * 100)
...
json_path = (
    OUT
    / "teacher_s_r2_fast_v1_size_aware.json"
)

csv_path = (
    OUT
    / "teacher_s_r2_fast_v1_size_aware.csv"
)
